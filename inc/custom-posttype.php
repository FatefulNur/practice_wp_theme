...
function sunset_save_email_data($post_id) {
    if(!isset($_POST['sunset_contact_email_meta_box_nonce'])) {
        return;
    } // Checking of the nonce existence

    if(!wp_verify_nonce( $_POST['sunset_contact_email_meta_box_nonce'], 'sunset_save_email_data' )) {
        return;
    } // Verifying the nonce

    if( defined('DOING_AUTOSAVE') && DOING_AUTOSAVE ) {
        return;
    } // Checking if data saving without submitting
    ...
    if(!isset($_POST['sunset_contact_email_field'])) {
        return;
    } // Checking of the field existing
